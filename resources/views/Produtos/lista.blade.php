...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <div class="container">
            <h1 class="d-flex justify-content-center">Lista de Produtos</h1>
            <a class="btn btn-primary mb-1" href="/produtos/cadastrar">Cadastrar</a>
            <!-- Mostra mensagem de acordo com a ação tomada no CRUD -->
            ...
            @if(sizeof($produtos)==0)
                <h3 class="d-flex justify-content-center mt-3" style="font-weight:bold">Nenhum produto cadastrado</h3>
            @else
                <table class="table">
                    ...
                    <!-- Busca os produtos para listá-los na tabela -->
                    @foreach($produtos as $produto)
                        ...
                        <tbody>
                            ...
                            <td>
                                <!-- Método usado para mostrar o nome da categoria, em vez do ID -->
                            ...
                            <td style="display:flex; justify-content:center">
                                <a class="btn btn-warning mr-2" href="/produtos/{{$produto->id}}">Editar</a>
